...
const AddProduct = () => {
    ...
    return (
        <div className='flex justify-center w-full'>
            <form className='w-2/5 flex flex-col gap-4 p-4' onSubmit={addProduct}>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <textarea className='border border-buttonBg rounded-lg w-full p-2 resize-none focus:outline-none' name="description" id="" cols="30" rows="5" placeholder="Enter the product's description" required onChange={handleChange}></textarea>
                </div>
                <div>
                    <label htmlFor="image">Image</label>
                    <input className='border border-buttonBg rounded-lg w-full p-2 focus:outline-none' type="text" name='image' placeholder='Enter the image url of the product' required onChange={handleChange} />
                </div>
                <div>
